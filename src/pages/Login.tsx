  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="bg-nebula-gray/80 backdrop-blur-sm border-neutral-700 text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Input
                  ...
                  disabled={isLoading}
                  className="bg-nebula-dark text-white border-neutral-600 placeholder:text-neutral-400"
                  required
                />
              </div>
